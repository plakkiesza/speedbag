...
void loop()
{
  ...
  //remove old average dta
  averagePass-= mybuff[buffcnt]/76;
  //add new dta to array
  mybuff[buffcnt] = abs(currentMagnitude;)
  //get new average
  averagePass+= mybuff[buffcnt]/76;
  //move buffer on for next value
  buffcnt+=1;
  if (buffcnt >75)
  {
    buffcnt = 0;
  ...
  if (averagePass > MIN_MAGNITUDE_THRESHOLD)
  {
