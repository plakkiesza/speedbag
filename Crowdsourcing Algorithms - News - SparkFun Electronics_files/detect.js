...
this.browser = new Browser({ channel: "Dev", stock: false, hidden: false, mode: "", name: "Chrome", version: new Version({ value: "49.0.2623.87", hidden: false }) });
this.engine = new Engine({ name: "Blink", version: new Version({ value: "537.36", hidden: false }) });
this.os = new Os({ name: "Linux" });
